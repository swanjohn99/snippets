...
if(location.hostname.match('internationalsexguide')){
  ...
  [].forEach.call(document.querySelectorAll('.bbcode_container,.postfoot,.isg_notice,.options_block,.pagination_bottom,.pagination,.above_postlist,.nodecontrols'), function (el) {
